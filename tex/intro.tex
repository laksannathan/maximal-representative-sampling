...
Consider the questions above as binary classification problem: Predict "person (does not) vote on election day" - with information theory based feature selection mechanisms to calculate the mutual information of attributes "Resilienz" and "Gruppe: Positiv/Negativ Statement".
